...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      {/* Hero Section */}
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-32">
        <div className="space-y-8">
          <div className="space-y-4">
            <h2 className="text-4xl sm:text-5xl font-bold leading-tight">
              I build websites & web apps for creators, traders, businesses & crypto projects
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition flex items-center justify-center gap-2"
            >
            ...
            <a 
              ...
              className="px-6 py-3 bg-slate-700 hover:bg-slate-600 rounded-lg font-semibold transition flex items-center justify-center gap-2"
            >
              Email
            </a>
          </div>
          <p className="text-sm text-slate-500 pt-4">💬 I respond within 2 hours on WhatsApp • We'll schedule a quick call to discuss your project</p>
        </div>
      </section>
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-cyan-500/50 transition">
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-slate-400">Bio link page builder</p>
              </div>
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-cyan-500/50 transition">
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-slate-400">Multi-course quiz platform</p>
              </div>
              <ExternalLink size={20} className="text-slate-500" />
            </div>
            <p className="text-slate-400 text-sm mb-4">
      ...
      {/* Services & Pricing */}
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <h3 className="text-2xl font-bold mb-8">What I Can Build</h3>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="grid sm:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 text-center">
            ...
            <p className="text-slate-400 text-sm">Days Avg Delivery</p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">5-7 days for most projects. No delays, no excuses.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-1 bg-gradient-to-b from-cyan-400 to-blue-500 rounded"></div>
              <div>
                ...
                <p className="text-slate-400 text-sm">Built with React, Tailwind, Firebase. Scalable & maintainable.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-1 bg-gradient-to-b from-cyan-400 to-blue-500 rounded"></div>
              <div>
                ...
                <p className="text-slate-400 text-sm">Every project works perfectly on phone, tablet, desktop.</p>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">I build for Web3 projects. I understand what you need.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-1 bg-gradient-to-b from-cyan-400 to-blue-500 rounded"></div>
              <div>
                ...
                <p className="text-slate-400 text-sm">No overpricing. Good value for quality work.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-1 bg-gradient-to-b from-cyan-400 to-blue-500 rounded"></div>
              <div>
                ...
                <p className="text-slate-400 text-sm">2 rounds of revisions. Get it right the first time.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-4 gap-4">
            ...
            <div className="relative">
              <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                ...
                <p className="text-slate-400 text-sm">Hit me up on WhatsApp with your idea. Quick response guaranteed.</p>
              </div>
            ...
            <div className="relative">
              <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                ...
                <p className="text-slate-400 text-sm">We discuss your needs, timeline, budget, and vision for the project.</p>
              </div>
              <div className="hidden sm:block absolute top-1/2 -right-2 w-4 h-0.5 bg-gradient-to-r from-cyan-500 to-transparent"></div>
            </div>
            ...
            <div className="relative">
              <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                ...
                <p className="text-slate-400 text-sm">Fast development with clean code. You get updates & can request changes.</p>
              </div>
              <div className="hidden sm:block absolute top-1/2 -right-2 w-4 h-0.5 bg-gradient-to-r from-cyan-500 to-transparent"></div>
            </div>
            ...
            <div>
              <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
                ...
                <p className="text-slate-400 text-sm">Site goes live. 2 rounds of revisions included. Ongoing support available.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="space-y-4">
          {/* FAQ Item 1 */}
          <details className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 cursor-pointer">
            ...
            <p className="text-slate-400 mt-4">Most projects are delivered in 5-7 days. Complex projects might take 1-2 weeks. I'll give you a clear timeline during our call.</p>
          </details>
          ...
          <details className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 cursor-pointer">
            ...
            <p className="text-slate-400 mt-4">Yes. 2 rounds of revisions are included in every project. Need more after that? Just message me and we'll sort out something fair. We'll get your site right before launch.</p>
          </details>
          ...
          <details className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 cursor-pointer">
            ...
            <p className="text-slate-400 mt-4">I respond within 2 hours on WhatsApp during business hours. For urgent matters, message me directly and I'll get back to you ASAP.</p>
          </details>
          ...
          <details className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 cursor-pointer">
            ...
            <p className="text-slate-400 mt-4">Yes. I include 30 days of free support after launch for bug fixes and small tweaks. Extended support & maintenance can be arranged based on your needs.</p>
          </details>
          ...
          <details className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 cursor-pointer">
            ...
            <p className="text-slate-400 mt-4">Absolutely. If you have existing code from another dev, I can take over, debug, improve, or add features to it. Just send me the details.</p>
          </details>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-20 border-t border-slate-700">
        <div className="bg-gradient-to-r from-slate-800 to-slate-700 border border-slate-600 rounded-xl p-8 sm:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition flex items-center justify-center gap-2"
            >
              <MessageCircle size={20} />
              Start on WhatsApp
            </a>
            <a 
              href="mailto:omotayomichael666@gmail.com"
              className="px-8 py-3 bg-slate-600 hover:bg-slate-500 rounded-lg font-semibold transition"
            >
              Email Me Instead
            </a>
          </div>
      ...
      <footer className="max-w-5xl mx-auto px-4 sm:px-6 py-12 border-t border-slate-700">
        <div className="space-y-8">
          ...
          <div className="pt-8 border-t border-slate-700 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-slate-500 text-sm">Built fast. Built to last.</p>
            <p className="text-slate-500 text-xs">© 2026 Hash. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
